...
void Barbarian::set_user_name(std::string name)
{
    this->user_name = name;
}

void Barbarian::set_team_name(std::string name)
{
    this->team_name = name;
}
...
std::string Barbarian::get_user_name()
{
    return user_name;
}

std::string Barbarian::get_team_name()
{
    return team_name;
}
